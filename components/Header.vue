    ...
    <div class="bg-gray-400">
        <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6">
            ...
            <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                ...
                <div>
                    <a href="#" class="inline-block text-sm px-4 py-2 leading-none border rounded text-black border-black hover:border-white hover:text-white hover:text-teal-500 mt-4 lg:mt-0">
                    Log In
                    </a>
                </div>
            </div>
